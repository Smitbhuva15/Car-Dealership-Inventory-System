...
import { ArrowLeft, Car, Save, AlertCircle, DollarSign, Layers, Tag, Hash } from "lucide-react";
    ...
    const fetchVehicle = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          price: vehicle.price !== undefined ? vehicle.price.toString() : "",
          quantity: vehicle.quantity !== undefined ? vehicle.quantity.toString() : "",
        });
      } catch (err: any) {
        const errorMsg = err.message || "Failed to load vehicle details.";
  ...
  return (
    <div className="max-w-2xl mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Edit Vehicle</h1>
          <p className="text-sm text-slate-500">Update specification, stock, or pricing for this vehicle</p>
        </div>
      </div>
